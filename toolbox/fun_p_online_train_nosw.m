function [] = fun_p_online_train_nosw(path_head,path_toolbox,path_data,subjectID,...
...
num_win_motion = 1;
num_win_rest = 1;    % (len_gesture-len_win)/len_step+1=(1-0.5)/0.1+1=6

dim = 100;

feature_motion_all = load_feature_nosw(path_data,subjectID,sessionID,'motion');
feature_rest_all = load_feature_nosw(path_data,subjectID,sessionID,'rest');
...
save([path_data,subjectID{i},sessionID{j},'/model_nosw.mat'],...
