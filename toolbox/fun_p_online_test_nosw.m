function [acc_rest_all,acc_gesture_all,acc] = fun_p_online_test_nosw(path_head,path_toolbox,path_data,subjectID,...
...
for num_choose = 1:length(index)
    ...
    load([path_data,subject_test,num2str(session_test),'/model_nosw.mat']);
