function [acc_rest_all,acc_gesture_all,acc] = fun_p_online_test_noms(path_head,path_toolbox,path_data,subjectID,...
...
%     end
    ...
    load([path_data,subject_test,num2str(session_test),'/model_noms.mat']);
...
%         label_predict_tmp_1 = zeros(1,n_model);
            ...
            %         mdl2_tmp = mdl2{1,i};
            feature_pca1 = feature_nor * P_pca1;
            label_predict_tmp_1 = my_cdem_singlesource_test...
                (feature_pca1,mdl1);
